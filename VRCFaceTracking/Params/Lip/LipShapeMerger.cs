...
namespace VRCFaceTracking.Params.LipMerging
{
    ...
    {
        private static readonly Dictionary<string, ILipMerger> MergedShapes =
            new Dictionary<string, ILipMerger>
            {
                ...
                {"SmileSad", new AvragePositiveNegativeShape(new LipShape_v2[]{ LipShape_v2.MouthSmileRight, LipShape_v2.MouthSmileLeft }, new LipShape_v2[]{ LipShape_v2.MouthSadRight, LipShape_v2.MouthSadLeft })},
                ...
                {"TongueOut", new AvrageShape(LipShape_v2.TongueLongStep1, LipShape_v2.TongueLongStep2)},
                ...
                {"ShowTeeth", new AvrageShape(LipShape_v2.MouthUpperUpLeft, LipShape_v2.MouthUpperUpRight, LipShape_v2.MouthLowerDownLeft, LipShape_v2.MouthLowerDownRight)},
