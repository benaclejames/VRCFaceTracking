    ...
    namespace anipal
    {
        namespace Lip
        {
            public enum LipShape_v2
            {
                ...
                Jaw_Open = 3,
                Mouth_Ape_Shape = 4,
                Mouth_Upper_Right = 5, // +MouthUpper
                Mouth_Upper_Left = 6, // -MouthUpper
                Mouth_Lower_Right = 7, // +MouthLower
                Mouth_Lower_Left = 8, // -MouthLower
                Mouth_Upper_Overturn = 9,
                Mouth_Lower_Overturn = 10,
                Mouth_Pout = 11,
                Mouth_Smile_Right = 12, // +SmileSadRight
                Mouth_Smile_Left = 13, // +SmileSadLeft
                Mouth_Sad_Right = 14, // -SmileSadRight
                Mouth_Sad_Left = 15, // -SmileSadLeft
                Cheek_Puff_Right = 16,
                Cheek_Puff_Left = 17,
                Cheek_Suck = 18,
                ...
                Tongue_LongStep1 = 26,
                Tongue_LongStep2 = 32,
                Tongue_Down = 30, // -TongueY
                Tongue_Up = 29, // +TongueY
                Tongue_Right = 28, // +TongueX
                Tongue_Left = 27, // -TongueX
                Tongue_Roll = 31,
