...
{
    private Dictionary<TKey1, TKey2> m_dic1 = new();
    private Dictionary<TKey2, TValue> m_dic2 = new();
    ...
    /// <summary>
    /// Returns an inner key given an outer key
    /// </summary>
    /// <param name="outerKey"></param>
    /// <returns></returns>
    public TKey2 GetInnerKey(TKey1 outerKey)
    {
        return m_dic1[outerKey];
    }
