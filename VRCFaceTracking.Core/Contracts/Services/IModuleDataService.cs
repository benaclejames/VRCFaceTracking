...
public interface IModuleDataService
{
    ...
    Task<Dictionary<string, ModuleEnabledSettings>> GetModuleSettingsAsync();
    Task SaveModuleSettingsAsync(InstallableTrackingModule module, ModuleEnabledSettings settings);
}